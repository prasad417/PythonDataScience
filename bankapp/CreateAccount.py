...
class CreateAccount:
    ...
    bank_account_number = bca.create_bank_account()
    ...
    bank_account_number = bsa.create_bank_account()
    ...
    bank_account_number = pca.create_bank_account()
    ...
    bank_account_number = psa.create_bank_account()
